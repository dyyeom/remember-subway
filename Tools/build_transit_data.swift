...
let lineSeeds: [LineSeed] = [
    LineSeed(
        ...
        patterns: [
            ...
            PatternSeed("gwangundae-sinchang", "광운대 → 신창", [
                "광운대", "석계", "신이문", "외대앞", "회기", "청량리|청량리(서울시립대입구)", "제기동", "신설동", "동묘앞", "동대문", "종로5가", "종로3가", "종각", "시청", "서울역||서울", "남영", "용산", "노량진", "대방", "신길", "영등포", "신도림", "구로", "가산디지털단지", "독산", "금천구청", "석수", "관악", "안양", "명학", "금정", "군포", "당정", "의왕", "성균관대", "화서", "수원", "세류", "병점", "세마", "오산대", "오산", "진위", "송탄", "서정리", "평택지제", "평택", "성환", "직산", "두정", "천안", "봉명", "쌍용|쌍용(나사렛대)", "아산", "탕정", "배방", "온양온천", "신창|신창(순천향대)"
            ]),
...
let catalog = Catalog(
    schemaVersion: 1,
    contentVersion: "2026.08.official.4",
    challengePoolVersion: "2026.08.4",
    dataAsOf: "2026-08-22",
    sources: [
